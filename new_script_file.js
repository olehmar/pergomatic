...
const subSystems_options = {
  ...
  //       minInch: 60, // Ã’â¬ÜÃ¢â¬ Ã’ÂÃÂµ Ã’ÂÃÂ²Ã’ÂÃÂ¸Ã’â¬ÜÃÂÃ’ÂÃÂ¾Ã’â¬ÜÃ¢â¬Å¡Ã’ÂÃÂ° Ã’ÂÃÂ¿Ã’ÂÃÂµÃ’â¬ÜÃ¢â¬aÂ¬Ã’ÂÃÂ³Ã’ÂÃÂ¾Ã’ÂÃÂ»Ã’ÂÃÂ¸ Ã’â¬ÜÃ â¬" Ã’â¬ÜÃ¢â¬Å¾Ã’â¬ÜÃ â¬"Ã’â¬ÜÃ¢â¬Å¡Ã’ÂÃÂ°Ã’â¬ÜÃ¢â¬Â¦
  //       maxInch: 144, // Ã’â¬ÜÃ¢â¬ Ã’ÂÃÂµ Ã’ÂÃÂ²Ã’ÂÃÂ¸Ã’â¬ÜÃÂÃ’ÂÃÂ¾Ã’â¬ÜÃ¢â¬Å¡Ã’ÂÃÂ° Ã’ÂÃÂ¿Ã’ÂÃÂµÃ’â¬ÜÃ¢â¬aÂ¬Ã’ÂÃÂ³Ã’ÂÃÂ¾Ã’ÂÃÂ»Ã’ÂÃÂ¸ Ã’â¬ÜÃ â¬" Ã’â¬ÜÃ¢â¬Å¾Ã’â¬ÜÃ â¬"Ã’â¬ÜÃ¢â¬Å¡Ã’ÂÃÂ°Ã’â¬ÜÃ¢â¬Â¦
  //     },
  //     width: {
  //       //! it used in pergola.changeDimensions();
              ...
              shader.vertexShader = shader.vertexShader
                ...
                .replace(
                  ...
                  `
                    ...
                    // Ã’ÂÃ&Â¸Ã’ÂÃÂ¾Ã’ÂÃÂ²Ã’ÂÃÂ¾Ã’â¬ÜÃ¢â¬aÂ¬Ã’ÂÃÂ¾Ã’â¬ÜÃ¢â¬Å¡ Ã’â¬ÜÃ¢â¬Å¡Ã’ÂÃÂµÃ’ÂÃÂºÃ’â¬ÜÃÂÃ’â¬ÜÃ¢â¬Å¡Ã’â¬ÜÃ â¬"Ã’â¬ÜÃ¢â¬aÂ¬Ã’ÂÃÂ¸ Ã’ÂÃÂ½Ã’ÂÃÂ° 90 Ã’ÂÃÂ³Ã’â¬ÜÃ¢â¬aÂ¬Ã’ÂÃÂ°Ã’ÂÃÂ´Ã’â¬ÜÃ â¬"Ã’â¬ÜÃÂÃ’â¬ÜÃ¢â¬â¬SÃ’ÂÃÂ²
...
function updateRangeBackgroundAndLabel(input) {
  ...
  if (val > max) {
    val = max;
    input.val(val); // ÃÅ¾ÃÂ½ÃÂ¾ÃÂ²ÃÂ»ÃÅ½Ãâ¬ÃÂ¼ÃÂ¾ ÃÂ·ÃÂ½ÃÂ°Ãâ¬¡ÃÂµÃÂ½ÃÂ½ÃÂ Ãâ¬ÃÂ½ÃÂ¿ÃÆÃâ¬aÃÆ
  }
...
function createPergola(model) {
  ...
  setTimeout(() => {
    ...
    // console.log("Ã’Â°Ã&Â¸Ã&Â¡Ã¢â¬aÂ¬ ~ createPergola ~ pergola:", pergola);
  }, 750);
}
//#endregion
...
class PergolaObject {
  ...
  getReversedCornerPoints() {
    ...
    const FL_point = new THREE.Vector3(
      lineXfront + offsetX / 2, // ÃÂ¨ÃÂ¸Ãâ¬ÃÂ¸ÃÂ½ÃÂ° Ãâ¬aÃÂµÃÂ¿ÃÂµÃâ¬ ÃÂ¿ÃÂ¾ ÃÂ¾ÃÂÃâ¬ Z, Ãâ¬aÃÂ¾ÃÂ¼ÃÆ Z ÃÂºÃÂ¾ÃÂ¾Ãâ¬ÃÂ´ÃÂ¸ÃÂ½ÃÂ°Ãâ¬aÃÂ° ÃÂ·ÃÂ±ÃÂµÃâ¬ÃÂµÃÂ¶ÃÂµÃÂ½ÃÂ°
      0,
      -totalWidth / 2 - offsetZ / 2 // Ãâ¬SÃÂ»ÃÂ¸ÃÂ±ÃÂ¸ÃÂ½ÃÂ° ÃÂ¿ÃÂ¾ ÃÂ¾ÃÂÃâ¬ X Ãâ¬aÃÂµÃÂ¿ÃÂµÃâ¬
    );
    const FR_point = new THREE.Vector3(
      lineXfront + offsetX / 2, // ÃÂ¨ÃÂ¸Ãâ¬ÃÂ¸ÃÂ½ÃÂ° ÃÂ¿ÃÂ¾ ÃÂ¾ÃÂÃâ¬ Z
      0,
      totalWidth / 2 + offsetZ / 2 // Ãâ¬SÃÂ»ÃÂ¸ÃÂ±ÃÂ¸ÃÂ½ÃÂ° ÃÂ¿ÃÂ¾ ÃÂ¾ÃÂÃâ¬ X
    );
    const RL_point = new THREE.Vector3(
...
async function convertToBlackAndWhite(base64Image) {
  return new Promise((resolve, reject) => {
    ...
    image.onload = () => {
      ...
      // ÃÅ¸ÃÂµÃâ¬ÃÂµÃâ¬aÃÂ²ÃÂ¾Ãâ¬ÃÂµÃÂ½ÃÂ½ÃÂ ÃÂ½ÃÂ° base64
...
const onMessage = function (e) {
  ...
  if (data?.type == "sendLeadInfo") {
    (async () => {
      let pdfBase = await createPDF("base64");
      let userData = { base64: pdfBase };
